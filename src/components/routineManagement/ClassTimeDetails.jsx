...
// Main Component
export default function ClassTimeDetails({ classTimeDetails, setClassTimeDetails, appliedClassTimeDetails, setAppliedClassTimeDetails, saveStatus, setSaveStatus }) {
  ...
  // Generate time slots and working days
